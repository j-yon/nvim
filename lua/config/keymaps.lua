...
keymap.set("n", "<leader>tp", function()
    ...
    vim.cmd("tabnew")
    vim.cmd("terminal /usr/bin/python3")
    vim.cmd("startinsert")
end, { desc = "Toggle python terminal" })
keymap.set("n", "<leader>tn", function()
    -- require("snacks").terminal.open("/usr/bin/node")
    vim.cmd("tabnew")
    vim.cmd("terminal /usr/bin/node")
    vim.cmd("startinsert")
end, { desc = "Toggle node terminal" })
keymap.set("n", "<leader>ts", function()
    -- require("snacks").terminal.open("/usr/bin/psql")
    vim.cmd("tabnew")
    vim.cmd("terminal /usr/bin/psql")
    vim.cmd("startinsert")
end, { desc = "Toggle psql" })
keymap.set("n", "<leader>th", function()
    -- require("snacks").terminal.open("/usr/bin/htop")
    vim.cmd("tabnew")
    vim.cmd("terminal /usr/bin/htop")
    vim.cmd("startinsert")
