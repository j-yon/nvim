...
--             update = function(grid)
--                 local matrix_chars = { "ｱ", "ｲ", "ｳ", "ｴ", "ｵ", "ｶ", "ｷ", "ｸ", "ｹ", "ｺ" }
--                 -- for _, char in ipairs(matrix_chars) do
--                 --     print(string.format("Char: %s, Byte length: %d, Display width: %d", char, vim.fn.strlen(char), vim.fn.strdisplaywidth(char)))
--                 -- end
--                 -- highlights
--                 local all_matrix_hls = { "MatrixGreen", "MatrixDark1", "MatrixDark2", "MatrixGlitch", "MatrixHead", "MatrixTail" }
--                 local core_matrix_hls = { "MatrixGreen", "MatrixDark1", "MatrixDark2" }
